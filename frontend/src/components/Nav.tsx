      ...
      >
        ...
        >
          <div className="flex flex-col space-y-2 p-4">
            <a href="/" className="hover:text-nebula transition-colors" onClick={toggleMenu}>
              Home
            </a>
            <a href="/#menu" className="hover:text-nebula transition-colors" onClick={toggleMenu}>
              Menu
            </a>
            <a href="/#about" className="hover:text-nebula transition-colors" onClick={toggleMenu}>
              About
            </a>
            <a href="/#contact" className="hover:text-nebula transition-colors" onClick={toggleMenu}>
              Contact
            </a>
            {isLoggedIn ? (
              <motion.button
