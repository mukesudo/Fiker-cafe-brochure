  ...
  return (
    <footer className="py-6 bg-cosmic text-white text-center">
      ...
      <div className="mt-2 space-x-4">
        <Link href="/#menu" className="hover:text-nebula">Menu</a>
        <Link href="/#about" className="hover:text-nebula">About</a>
        <Link href="/#contact" className="hover:text-nebula">Contact</a>
      </div>
